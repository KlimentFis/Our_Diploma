...
## Тестирование с помощью устройства Android, подключенного к той же сети
Все ссылки в приложении должны иметь ввид 

http:// + Адрес_полученный_с_помощью_сканирования_сети + :8888

Адрес должен быть http://localhost:8888

## Заключение
Данное Rest API тестировалось с помощью ноутбука с запущенным Rest API и телефоном под управлением операционной системой Android